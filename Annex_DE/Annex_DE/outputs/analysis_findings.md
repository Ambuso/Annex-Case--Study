# Portfolio Analysis â€” Findings
## 3A. Portfolio health
Across the 5 snapshots from 2025-01-01 to 2025-12-30, the active book grew from **8,812 â†’ 20,501 loans**, with outstanding balance moving from KES 335.5M to KES 654.9M.
...
3. Replace daily snapshots with an event-stream (payment_made, status_changed, arrears_updated) â€” derive snapshots downstream. This removes the filename/internal-date drift class of bugs entirely.
